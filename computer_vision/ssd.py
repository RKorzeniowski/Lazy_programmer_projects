...
MODELS_PATH = '../tensorflow_models/research/object_detection'
sys.path.append(RESEARCH_PATH)
sys.path.append(MODELS_PATH)

# import local modules
#import tensorflow_models.research.object_detection 
import object_detection 

from utils import label_map_util
from utils import visualization_utils as vis_util

#import tensorflow_models.research.object_detection.utils.label_map_util
#import tensorflow_models.research.object_detection.utils.visualization_utils as vis_util 
...
with detection_graph.as_default():
  with tf.Session(graph=detection_graph) as sess:
    ...
    # input_video = 'safari'
    input_video = 'traffic'
    video_reader = imageio.get_reader('cnn_class2_videos/%s.mp4' % input_video)
